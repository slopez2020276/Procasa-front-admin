...
@Component({
  selector: 'app-nuestros-cliente',
  templateUrl: './nuestros-cliente.component.html',
  styleUrl: './nuestros-cliente.component.css'
})
export class NuestrosClienteComponent {
...
ModalEdit(){ this.modalEdit?.classList.toggle('toggle') }
